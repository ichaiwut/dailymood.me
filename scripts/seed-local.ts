...
async function main() {
  ...
  const articles = [
    ...
    {
      slug: "recognizing-burnout-before-its-too-late",
      cat: "psychology", tone: "lavender", days: 1,
      titleTh: "รู้จัก Burnout ก่อนที่จะสายเกินไป",
      titleEn: "Recognizing Burnout Before It's Too Late",
      excerptTh: "เหนื่อยแบบพักแล้วก็ไม่หาย? อาจไม่ใช่แค่ขี้เกียจ แต่เป็นสัญญาณบางอย่าง",
      excerptEn: "Rest doesn't help anymore? It might not be laziness — it could be burnout.",
      bodyTh: `หลายคนเคยรู้สึกแบบนี้ไหม? ตื่นเช้ามาก็เหนื่อยแล้ว ทำงานไปวันๆ แบบไม่มีแรง พักผ่อนแล้วก็ไม่รู้สึกดีขึ้น...\n\nถ้าเป็นแบบนี้ต่อเนื่อง อาจไม่ใช่แค่ "ขี้เกียจ" หรือ "พักผ่อนไม่พอ" แต่อาจเป็นสัญญาณของ **Burnout** — ภาวะหมดไฟ\n\n---\n\n## 1. Burnout ไม่เหมือนกับเหนื่อยธรรมดา\n\nความเหนื่อยปกติ พักแล้วหาย แต่ Burnout ต่างออกไป เพราะมันเป็นความเหนื่อยล้าทั้งกาย ใจ และอารมณ์ ที่สะสมมานาน จนร่างกายส่งสัญญาณว่า "พอแล้ว"\n\nลองเช็กดูว่าตัวเองมีอาการเหล่านี้ไหม:\n\n- **หมดแรงจูงใจ** — สิ่งที่เคยชอบทำกลับรู้สึกเฉยๆ\n- **หงุดหงิดง่ายกว่าปกติ** — เรื่องเล็กๆ ก็ทำให้โมโห\n- **รู้สึกว่าทำอะไรก็ไม่ดีพอ** — ทั้งที่พยายามเต็มที่แล้ว\n- **แยกตัวออกจากคนรอบข้าง** — ไม่อยากคุยกับใคร\n- **ร่างกายส่งสัญญาณ** — ปวดหัวบ่อย นอนไม่หลับ ป่วยง่าย\n\n---\n\n## 2. ทำไมถึงเกิด Burnout?\n\nBurnout ไม่ได้เกิดจากทำงานหนักอย่างเดียว แต่เกิดจากหลายปัจจัยรวมกัน\n\n- **ทำมากแต่ไม่ได้พัก** — ไม่ให้เวลาตัวเองหายใจ\n- **ไม่มีอำนาจควบคุม** — รู้สึกว่าเลือกอะไรไม่ได้\n- **ไม่ได้รับการยอมรับ** — ทำดีแค่ไหนก็ไม่มีคนเห็น\n- **กดดันตัวเองมากเกินไป** — ตั้งมาตรฐานสูงจนเกินจริง\n\n---\n\n## 3. สิ่งเล็กๆ ที่ช่วยได้ ก่อนที่จะสาย\n\nBurnout ไม่ได้หายได้ข้ามคืน แต่สิ่งเล็กๆ เหล่านี้ช่วยให้เราค่อยๆ ดีขึ้นได้\n\n### บันทึกอารมณ์ทุกวัน\nแค่สังเกตว่าวันไหนรู้สึกยังไง ก็ช่วยให้เห็น pattern ว่าอะไรที่ทำให้เราหมดแรง\n\n### ตั้งขอบเขตให้ตัวเอง\nฝึกพูดว่า "ไม่" กับสิ่งที่ไม่จำเป็น ไม่ต้องรับทุกอย่างไว้คนเดียว\n\n### หาเวลา "ไม่ทำอะไร" บ้าง\nสมองต้องการเวลาว่าง ไม่ใช่ทุกนาทีต้องมีประโยชน์\n\n### พูดคุยกับคนที่ไว้ใจ\nบางทีแค่ได้เล่าให้ใครฟังก็ช่วยได้เยอะแล้ว\n\n---\n\n> ถ้าคุณอ่านมาถึงตรงนี้แล้วรู้สึกว่า "นี่คือเรา" — ขอบอกว่าคุณไม่ได้อ่อนแอ แค่เหนื่อยมานานเกินไป`,
      bodyEn: `Many of us have felt this way — waking up already tired, dragging through the day, and resting without feeling any better.\n\nIf this sounds familiar, it might not be laziness. It could be a sign of **burnout** — emotional and physical exhaustion that builds up over time.\n\n---\n\n## 1. Burnout Is Not Just Being Tired\n\nNormal tiredness goes away with rest. Burnout doesn't. It's a deep exhaustion of body, mind, and emotions that signals your system saying "enough."\n\nCheck if you recognize these signs:\n\n- **Lost motivation** — things you used to enjoy now feel "meh"\n- **Getting irritated easily** — small things set you off\n- **Feeling like nothing you do is good enough** — even when you're trying your best\n- **Withdrawing from people** — you don't want to talk to anyone\n- **Physical signals** — frequent headaches, insomnia, getting sick more often\n\n---\n\n## 2. What Causes Burnout?\n\nBurnout isn't just about working hard. It comes from a combination of factors:\n\n- **All work, no rest** — not giving yourself time to breathe\n- **No sense of control** — feeling like you can't make choices\n- **Lack of recognition** — no one sees your effort\n- **Perfectionism** — setting unrealistically high standards for yourself\n\n---\n\n## 3. Small Things That Help Before It's Too Late\n\nBurnout doesn't heal overnight, but small steps can make a real difference:\n\n### Track your mood daily\nJust noticing how you feel each day helps you spot patterns — what drains you and what recharges you.\n\n### Set boundaries\nPractice saying "no" to what's not essential. You don't have to carry everything alone.\n\n### Allow yourself to do nothing\nYour brain needs downtime. Not every minute has to be productive.\n\n### Talk to someone you trust\nSometimes just being heard is enough.\n\n---\n\n> If you've read this far and thought "this is me" — you're not weak. You've just been tired for too long.`,
      tags: ["Burnout", "จิตวิทยา", "สุขภาพจิต"],
    },
  ];
